...
$sql = "SELECT  name, password, is_admin FROM users where name = '$name' and password = '$pass' ";
$result = $conn->query($sql);
// print_r($result->fetch_assoc());
if($row = $result->fetch_assoc()){
    if($row['is_admin']=='t'){
        print_r($row);
        // header("Location:../cafe/home.php"); the next page
        
    }else {
        header("Location:../cafe/home.php");
